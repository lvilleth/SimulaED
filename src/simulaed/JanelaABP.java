 ...
 */
    public class ABPCirculo {
        ...
        private No buscaPai(No T, int valor){
            ...
            if((dir != null) && (dir.getDado().getValor() == valor))
                return T; 

            if((esq != null) && (esq.getDado().getValor() == valor))
                return T; 

            if (valor < T.getDado().getValor())
